...
while True:
    try:
     ...
     if lang == 2:
        ...
        while True:
            hs=random.randint(1,rs)
            print('waiting for 3 seconds...who will come to answer the question?')
            time.sleep(1)
            print('Waiting for just 2 seconds now, drink a cup of tea..?  XD')
            time.sleep(1)
            print('who will die？After 1 seconds we can know :)')
            time.sleep(1)
